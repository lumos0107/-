...
import com.gildongmu.application.dto.RunHistoryResponse;
...
public class RunController {
    ...
    @GetMapping("/history")
    public ResponseEntity<List<RunHistoryResponse>> history(@RequestParam int userId) {
        return ResponseEntity.ok(
            runService.getHistory(userId).stream()
                .map(RunHistoryResponse::new)
